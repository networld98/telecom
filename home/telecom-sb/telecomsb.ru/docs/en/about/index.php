...
$APPLICATION->SetTitle("Telecomsb | About company");
?>
<?
    ...
    <div class="page-content about-page">
        ...
        <div class="top-section padded">
            <div class="padded-inner">
                <div class="left">
                    <h1 class="header">About company</h1>
                    <div class="text">
                        <?$APPLICATION->IncludeFile("/en/include/company_text.php", Array(), Array(
                            "MODE"      => "php",
                ...
                <div class="right">
                    <?/*$APPLICATION->IncludeFile("/en/include/presentation.php", Array(), Array(
                        "MODE"      => "php",
                        "NAME"      => "Редактирование включаемой области раздела",
                        "TEMPLATE"  => "section_include_template.php"
                    ));*/?>
                ...
                <div class="nav">
                    ...
                    <div class="view-wrapper">
                        <div class="view"><div>
                                <div class="dup"></div>
                                <?
                                $arFilter = Array("IBLOCK_ID"=>"85","ACTIVE"=>"Y");
        ...
        <div class="partners-section padded">
            <div class="padded-inner">
                ...
                <div class="text">
                    <?$APPLICATION->IncludeFile("/en/include/partners_text.php", Array(), Array(
                        "MODE"      => "php",
                        "NAME"      => "Редактирование включаемой области раздела",
                        "TEMPLATE"  => "section_include_template.php"
                    ));?>            </div>
        ...
        <div class="licenses-section padded">
            <div class="padded-inner">
                <h2 class="header">Licenses and certificates</h2>
                <div class="text">
                    <?$APPLICATION->IncludeFile("/en/include/license_text.php", Array(), Array(
                        "MODE"      => "php",
                        "NAME"      => "Редактирование включаемой области раздела",
                        "TEMPLATE"  => "section_include_template.php"
                    ));?>
