...
$APPLICATION->SetTitle("Telecomsb");
    ...
    <div class="page-content start-page">
            <div class="top-section padded">
                <div class="padded-inner">
                    <?
                    $arFilter = Array("IBLOCK_ID"=>"82","ACTIVE"=>"Y");
                    ...
                    <div class="big" style="background-image: url(<?echo $banner['src']?>);">
                        ...
                        <div class="bottom">
                            <div class="caption">On the picture: <?=$arFields['PROPERTY_ONPHOTO_VALUE']?></div>
                    ...
                    <div class="news">
                        ...
                        <div class="list swiper-container">
                            <div class="swiper-wrapper">
                                <?
                                $arFilter = Array("IBLOCK_ID"=>"90","ACTIVE"=>"Y");
                                ...
                                while($ob = $res->GetNextElement()){
                                    ...
                                    <a href="<?=$arFields["DETAIL_PAGE_URL"]?>" class="swiper-slide">
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="more yellow-underlined-href">More details</div>
                                        </div>
                                    </a>
                                <?}?>
                            </div>
            ...
            <div class="info-section padded">
                <div class="padded-inner">
                    <div class="info">
                        <?$APPLICATION->IncludeFile("/en/include/index_bottom_block.php", Array(), Array(
                            "MODE"      => "php",
